...
Node* BST::deleteNode(Node *currNode, int value)
{
  ...
  else
  {
    ...
    else if(currNode->left == NULL)
    {
        ...
        currNode->right = deleteNode(currNode->right, getMinValueNode(currNode->right)->key);
    }
    //TODO Case : Only left child
    else if(currNode->right == NULL)
    {
        currNode->key = getMaxValueNode(currNode->left)->key;
        currNode->left = deleteNode(currNode->left, getMaxValueNode(currNode->left)->key);
    }
    ...
    else
    {
        ...
        temp = deleteNode(currNode->right, currNode->key);
    }
